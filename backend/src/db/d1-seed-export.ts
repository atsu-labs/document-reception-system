...
async function exportSeed() {
  ...
  try {
    ...
    // 届出1: 新築工事届（追加データあり）
    sqlStatements.push(
      `INSERT INTO notifications (id, notification_type_id, notification_date, receiving_department_id, processing_department_id, property_name, content, additional_data, certificate_issue_department_id, certificate_issue_date, completion_date, current_status, created_by, created_at, updated_at, updated_by) VALUES ('${notificationIds.notification1}', '${notificationTypeIds.newConstruction}', '${today}', '${deptIds.general}', '${deptIds.engineering}', '${escapeSqlString('サンプル物件A')}', '${escapeSqlString('新築工事の届出です')}', '${escapeSqlString(additionalDataSample1)}', NULL, NULL, NULL, '${escapeSqlString('受付')}', '${userIds.general}', datetime('now'), datetime('now'), '${userIds.general}');`
    );
    // 届出2: 修繕工事届（追加データなし）
    sqlStatements.push(
      `INSERT INTO notifications (id, notification_type_id, notification_date, receiving_department_id, processing_department_id, property_name, content, additional_data, certificate_issue_department_id, certificate_issue_date, completion_date, current_status, created_by, created_at, updated_at, updated_by) VALUES ('${notificationIds.notification2}', '${notificationTypeIds.repair}', '${today}', '${deptIds.general}', '${deptIds.engineering}', '${escapeSqlString('サンプル物件B')}', '${escapeSqlString('外壁修繕の届出です')}', NULL, NULL, NULL, NULL, '${escapeSqlString('処理中')}', '${userIds.general}', datetime('now'), datetime('now'), '${userIds.senior}');`
    );
    // 届出3: 解体工事届（追加データあり）
    sqlStatements.push(
      `INSERT INTO notifications (id, notification_type_id, notification_date, receiving_department_id, processing_department_id, property_name, content, additional_data, certificate_issue_department_id, certificate_issue_date, completion_date, current_status, created_by, created_at, updated_at, updated_by) VALUES ('${notificationIds.notification3}', '${notificationTypeIds.demolition}', '${pastDate}', '${deptIds.general}', '${deptIds.engineering}', '${escapeSqlString('サンプル物件C')}', '${escapeSqlString('老朽化建物の解体工事')}', '${escapeSqlString(additionalDataSample2)}', NULL, NULL, NULL, '${escapeSqlString('検査')}', '${userIds.general}', datetime('now'), datetime('now'), '${userIds.senior}');`
    );
    sqlStatements.push('');
